<?php $pageTitle="Richard Akomea-Early Life"; ?>
<?php include "inc/html-top.php"; ?>
<body class="container">
<header >
	<a href="index.php">
		<h1>Richard O Akomea</h1>
        <img src="images/richie.jpg" alt="Richard Akomea Photo">
    </a>
</header>
<aside>
	<ul>
	<li>Exceptionally Smooth</li>
	<li>Magnificent and Ghetto</li>
	<li>Student of Computer Science</li>
	</ul>
</aside>
<?php include "inc/nav.php"; ?>
<?php include "inc/homenav2.php"; ?>
<main>
	<h1>Early Life</h1>
